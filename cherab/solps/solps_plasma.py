...
def _test_solps_outputfile_plasma():

    sim = SOLPSSimulation.load_from_output_files('/home/matt/CCFE/cherab/demo/aug/solpsfiles/b2fgmtry',
                                                 '/home/matt/CCFE/cherab/demo/aug/solpsfiles/b2fstate', debug=True)
    ...
    d0 = plasma.composition[0]
    d1 = plasma.composition[1]
    te_samples = np.zeros((500, 500))
    ne_samples = np.zeros((500, 500))
    ...
    for i, x in enumerate(xrange):
        for j, y in enumerate(yrange):
            ...
            inside_samples[j, i] = plasma.inside_outside(x, 0.0, y)
...
# old reference case 40195
def _test_mdsplus_solps_plasma(mds_server='solps-mdsplus.aug.ipp.mpg.de:8001', ref_number=82608):
    ...
    vessel = mesh.vessel
    n0 = plasma.get_species(nitrogen, 0)
    n1 = plasma.get_species(nitrogen, 1)
    n2 = plasma.get_species(nitrogen, 2)
    n3 = plasma.get_species(nitrogen, 3)
    n4 = plasma.get_species(nitrogen, 4)
    n5 = plasma.get_species(nitrogen, 5)
    n6 = plasma.get_species(nitrogen, 6)
    n7 = plasma.get_species(nitrogen, 7)
    ...
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("electron density")
    ...
    plt.title("electron temperature")
    plt.figure()
    plt.imshow(n0_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    ...
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NII density")
    plt.figure()
    plt.imshow(n2_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NIII density")
    plt.figure()
    plt.imshow(n3_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NIV density")
    plt.figure()
    plt.imshow(n4_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NV density")
    plt.figure()
    plt.imshow(n5_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NVI density")
    plt.figure()
    plt.imshow(n6_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NVII density")
    plt.figure()
    plt.imshow(n7_samples, extent=[xl, xu, yl, yu], origin='lower')
    for i in range(vessel.shape[0]):
        plt.plot([vessel[i, 0], vessel[i, 2]], [vessel[i, 1], vessel[i, 3]], 'b')
    plt.colorbar()
    plt.xlim(xl, xu)
    plt.ylim(yl, yu)
    plt.title("NVIII density")
    plt.show()
...
if __name__ == '__main__':
    plasma =_test_mdsplus_solps_plasma()