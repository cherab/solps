...
auditwheel repair dist/cherab-solps-*-cp37-cp37m-linux_x86_64.whl --plat $PLAT
auditwheel repair dist/cherab-solps-*-cp38-cp38-linux_x86_64.whl --plat $PLAT
auditwheel repair dist/cherab-solps-*-cp39-cp39-linux_x86_64.whl --plat $PLAT
